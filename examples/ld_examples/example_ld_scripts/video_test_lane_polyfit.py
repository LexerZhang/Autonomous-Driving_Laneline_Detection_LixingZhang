...
cap1 = cv2.VideoCapture("../example_ld_input/test_videos/" + input_name)
fourcc = cv2.VideoWriter_fourcc(*'DIVX')
out = cv2.VideoWriter("../example_ld_output/test_videos_output/processed_" + input_name, fourcc, 30.0, (1280, 720))
